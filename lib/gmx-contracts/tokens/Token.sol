...
contract Token is IERC20 {
     ...
     * applications that interact with token gmx-contracts will not expect
     ...
     *
     * To learn more about hooks, head to xref:ROOT:extending-gmx-contracts.adoc#using-hooks[Using Hooks].
     */
